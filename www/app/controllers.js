...
myApp.controller('SecondCtrl', function($scope, fhcloud) {
    console.log('SecondCtrl', $scope);
    ...
    var success = function(res) {
        console.log("exampleAction success with", res);
    ...
    var error = function(msg, err) {
        alert("fhcloud > exampleAction > failed " + JSON.stringify(err));
    };
